...
def average_data(algorithm="", dataset="",  times=10):
    test_acc = get_all_results_for_one_algo(algorithm, dataset,  times)
...
def get_all_results_for_one_algo(algorithm="", dataset="", times=10):
    test_acc = []
