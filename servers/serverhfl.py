...
class HierFL(Server):
    ...
    def initialize_edges(self):
        ...
        for i in range(self.num_edges):
            ...
            [edges[i].client_register(self.clients[cid]) for cid in selected_cids]
    ...
    def aggregate_gradients(self):
        ...
        for layer,param in self.global_model.named_parameters():
            ...
            for i in range(len(self.received_gradients)):
                weighted_layer = torch.add(weighted_layer,self.received_gradients[i][layer],alpha= self.client_weights[i])
